...
float4 GetAlbedo (Interpolators i) {
	float4 albedo =
		tex2D(_MainTex, i.uv.xy) * UNITY_ACCESS_INSTANCED_PROP(_Color_arr, _Color);
	#if defined (_DETAIL_ALBEDO_MAP)
		float4 details = tex2D(_DetailTex, i.uv.zw) * unity_ColorSpaceDouble;
