...
public static class SdfNodeMenus
{
    ...
    static void CreateSphere(MenuCommand cmd) => Create("Sphere", SdfNodeType.Sphere, cmd);

    [MenuItem("GameObject/SDFs/1 - Primitives/Box", false, 2)]
    static void CreateBox(MenuCommand cmd) => Create("Box", SdfNodeType.Box, cmd);

    [MenuItem("GameObject/SDFs/1 - Primitives/Torus", false, 2)]
    static void CreateTorus(MenuCommand cmd) => Create("Torus", SdfNodeType.Torus, cmd);

    // ── Binary operators ──────────────────────────────────────────────────────
    [MenuItem("GameObject/SDFs/2 - Binary Operations/Union", false, 2)]
    static void CreateUnion(MenuCommand cmd) => CreateOp("Union", SdfNodeType.Union, cmd);

    [MenuItem("GameObject/SDFs/2 - Binary Operations/Intersect", false, 2)]
    static void CreateIntersect(MenuCommand cmd) => CreateOp("Intersect", SdfNodeType.Intersect, cmd);

    [MenuItem("GameObject/SDFs/2 - Binary Operations/Subtract", false, 2)]
    static void CreateSubtract(MenuCommand cmd) => CreateOp("Subtract", SdfNodeType.Subtract, cmd);

    // ── Unary operators ───────────────────────────────────────────────────────
    [MenuItem("GameObject/SDFs/3 - Unary Operations/Shell", false, 2)]
    static void CreateShell(MenuCommand cmd) => CreateOp("Shell", SdfNodeType.Shell, cmd);

    [MenuItem("GameObject/SDFs/3 - Unary Operations/Expand", false, 2)]
    static void CreateExpand(MenuCommand cmd) => CreateOp("Expand", SdfNodeType.Expand, cmd);

    // ── Primitive helper ──────────────────────────────────────────────────────
    static void Create(string name, SdfNodeType type, MenuCommand cmd)
    {
    ...
    static void CreateOp(string name, SdfNodeType type, MenuCommand cmd)
    {
